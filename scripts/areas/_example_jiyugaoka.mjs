...
export default {
  ...
  spots: [
    { name: "谷畑の権現さま（自由が丘熊野神社）", description: "自由が丘の総鎮守。御朱印（来訪証明）の本家であり、あなたが集める押印の原点。", address: "東京都目黒区自由が丘1-24-12", lat: 35.609138, lng: 139.669865,
    ...
    { name: "暮らしをDIYする店（TODAY'S SPECIAL Jiyugaoka）", description: "「食とくらしのDIY」がテーマの旗艦店。", address: "東京都目黒区自由が丘2-17-8", lat: 35.608933, lng: 139.666144,
    ...
    { name: "川の上を歩いていた（九品仏川緑道／グリーンストリート）", description: "駅南口からのびる石畳の散歩道。九品仏川を1974年に暗渠化してできた道。", address: "東京都目黒区自由が丘1丁目", lat: 35.606353, lng: 139.668630,
