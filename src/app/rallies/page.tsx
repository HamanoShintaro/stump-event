...
export default async function RalliesPage({ searchParams }: { searchParams?: Promise<{ [key: string]: string | string[] | undefined }> }) {
    ...
    <div className="container">
      <header>
        <Link href="/" className="nav-logo">
          <img src="/logo-square.png" alt="勝手にスタンプラリー" style={{ height: "44px", width: "44px", display: "block", objectFit: "contain" }} />
        </Link>
        <HeaderNav />
      </header>
